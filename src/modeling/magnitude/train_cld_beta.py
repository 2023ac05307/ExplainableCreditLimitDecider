...
@dataclass
class TrainCLDMagConfig:
    train_parquet: str
    val_parquet: str
    out_ckpt: str = "checkpoints/mag_cld_beta.pt"
...
def run_train_cld(conf: TrainCLDMagConfig) -> Dict[str, Any]:
    core = MagBetaConfig(
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    p.add_argument("--out", default="checkpoints/mag_cld_beta.pt")
